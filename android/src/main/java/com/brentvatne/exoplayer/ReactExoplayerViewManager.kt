...
class ReactExoplayerViewManager(private val config: ReactExoplayerConfig) : ViewGroupManager<ReactExoplayerView>() {
    ...
    companion object {
        ...
        private const val PROP_WATERMARK_TEXT = "watermarkText"
    }
    ...
    @ReactProp(name = PROP_WATERMARK_TEXT)
    fun setWatermarkText(videoView: ReactExoplayerView, text: String?) {
        videoView.setWatermarkText(text)
    }
}
